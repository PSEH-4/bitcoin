...
public class BitcoinControllerTest {
	...
	@MockBean
	private BitcoinPriceService bitcoinPriveServiceImpl;
	...
	public void testWhenGetCurrency() throws Exception {
		...
		Mockito.when(bitcoinPriveServiceImpl.fetchPrice(Mockito.any(Request.class))).thenReturn(response);

		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/bitcoin/a/b/c").accept(MediaType.APPLICATION_JSON);
